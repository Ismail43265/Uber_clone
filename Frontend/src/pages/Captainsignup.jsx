...
const Captainsignup = () => {
  ...
  return (
    <div className="p-7 h-screen flex flex-col justify-between">
        ...
        <button className="w-full bg-green-700 text-white py-3 rounded mt-5"> Create </button>
            </form>
      <Link to='/captain-login' className="text-blue-600 text-center">login using email</Link>
        </div>
    </div>
  );
};
